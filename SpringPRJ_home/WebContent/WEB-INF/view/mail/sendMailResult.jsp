...
<%
	...
	// 0이면 메일 발송 실패하는것으로 스프링의 Service에서 정의했기때문에 0으로 한것임
	String jspRes = CmmUtil.nvl((String)request.getAttribute("res"), "0");

	// 웹 URL로부터 전달받는 값들(스프링은 기본적으로 포워드 방식으로 페이지를 이동하기 떄문에 url에 입력받은 request 값을 가져올 수 있음, 일반적인 jsp에선 불가능함)
...
// 메일 발송이 성공했다면
if (jspRes.equals("1")){
	out.println(toMail + "로 메일 정송이 성공 하였습니다.");
